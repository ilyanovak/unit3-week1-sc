...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  **ILYA: Try to find as much inefficiency as possible. See how many places in which you can find a simpler, more elegant, and clearer mechanism to accomplish the coder's goals. Find code which is particularly ugly and difficult to read and understand by people unfamiliar with it.** 
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  **ILYA: Containers would help us by storing all libraries and dependencies necessary for each part of the application seperate from the others. This frees up sace and RAM for all users who thereby don't need to deal with tools which don't concern their part of the application. It also makes it easier for other coders to switch to another part of the application to their computer without going through the hassle of having to set up them all up anew.**
